...
def test_mnemonic_decode_12_words():
...
def test_mnemonic_decode_24_words():
...
def test_mnemonic_decode_exception_length():
...
def test_mnemonic_decode_exception_word():
    with pytest.raises(Exception) as exc:
...
def test_mnemonic_decode_exception_checksum():
    with pytest.raises(Exception) as exc:
